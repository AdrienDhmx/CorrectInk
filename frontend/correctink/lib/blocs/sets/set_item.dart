    ...
    if (set.isValid) {
      return ListTile(
        ...
        trailing: SetPopupOption(realmServices,
            ...
            canReport: !realmServices.userService.currentUserData!.reportedSets.any((s) => s.id == set.id),
            like: realmServices.userService.currentUserData!.likedSets.any((s) => s.id == set.id),
        ),
